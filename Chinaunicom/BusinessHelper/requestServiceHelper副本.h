...
//获取报告列表
- (void)getReportList:(NSMutableDictionary *)dictionary sucess:(void (^) (NSMutableArray *reportDictionary,NSInteger result))sucess falid:(void (^) (NSString *errorMsg))faild;
//获取报告详细内容
...
//获取分类
-(void) getReportType:(NSString *)url paramter:(NSString *)userid sucess:(void(^)(NSArray *array))sucess falid:(void(^)(NSString *errorMsg))faild;
//添加和删除分类
