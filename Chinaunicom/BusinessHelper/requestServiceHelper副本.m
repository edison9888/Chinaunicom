...
#pragma mark- 获取报告类型
-(void)getReportType:(NSString *)url paramter:(NSString *)userid sucess:(void (^)(NSArray *))sucess falid:(void (^)(NSString *))faild
{
    NSMutableDictionary *dir=[[NSMutableDictionary alloc] init];
    [dir setValue:@"1" forKey:@"pageIndex"];
    [dir setValue:@"100" forKey:@"pageSize"];
    [dir setValue:userid forKey:@"userId"];
    [HttpRequestHelper asyncGetRequest:url parameter:dir requestComplete:^(NSString *responseStr) {
        //code
        NSData *data = [responseStr dataUsingEncoding: NSUTF8StringEncoding];
