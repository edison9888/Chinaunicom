...
-(void)initDataSource
{
    ...
    [dictionary setValue:@"65" forKey:@"repTypeId"];
    //NSLog(@"%@",userid);
...
//            [self.myTableView reloadData];
              NSLog(@"-------------reportDictionary  count:%d",reportDictionary.count);
...
-(void)hideLoadingActivityView{
    ...
    [UIView animateWithDuration:AnnimationTime delay:0 options:UIViewAnimationCurveEaseOut animations:^{
