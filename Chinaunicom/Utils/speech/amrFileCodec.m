...
{
    int nPos = 0;
	memset(frameBuffer, 0, sizeof(frameBuffer[0]));
...
//#ifdef DEBUG
    ...
    NSString *wavFile        = [[documentPath stringByAppendingPathComponent:@"SpeechSoundDir"] stringByAppendingPathComponent:[NSString stringWithFormat:@"alreadyEncoderData.amr"]];
